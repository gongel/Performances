...
do
    echo ==================================================================================================================
    echo batch_size:$infer_batch_size, seq_len:$max_length, beam_size:$beam_size, beam_search_version:$beam_search_version
    echo ==================================================================================================================
    python3.7 -u encoder_decoding_sample.py --infer_batch_size ${infer_batch_size} --max_length ${max_length} --max_out_len ${max_length} --beam_size ${beam_size} --beam_search_version $beam_search_version --without_ft
done
done
done
done